...
The https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html-single/disconnected_environments/index#update-service-overview_updating-disconnected-cluster-osus[OpenShift Update Service Operator (OSUS)] provides a fleet of disconnected OpenShift clusters with centralized updates.
