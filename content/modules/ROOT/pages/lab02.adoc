...
** What to download (OpenShift itself, an Operator, a Helm chart, and specified images)
...
** This process downloads `~62` GB of data and takes up to `30` minutes in this workshop environment
...
* One additional image, `registry.redhat.io/rhel8/support-tools:latest`
...
[WARNING]
--
**It takes up to 30 minutes to download the installation images in this workshop environment depending on network conditions.**

Please run the next `oc-mirror` command in a `tmux` session.
This will allow you to move on to the next section while `oc-mirror` downloads `~62` GB of data.
...
----
cd /mnt/low-side-data
oc-mirror --v2 --config imageset-config.yaml file:///mnt/low-side-data
----
[.output]
----

2025/10/19 23:18:14  [INFO]   : 👋 Hello, welcome to oc-mirror
2025/10/19 23:18:14  [INFO]   : ⚙️  setting up the environment for you...
2025/10/19 23:18:14  [INFO]   : 🔀 workflow mode: mirrorToDisk 
2025/10/19 23:18:14  [INFO]   : 🕵  going to discover the necessary images...
2025/10/19 23:18:14  [INFO]   : 🔍 collecting release images...
